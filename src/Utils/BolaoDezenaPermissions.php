...
class BolaoDezenaPermissions
{
    ...
    const LIST_BOLLON = ['name' => 'bolaodezena.listar.bolao', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const LIST_RESULT = ['name' => 'bolaodezena.listar.resultado', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const LIST_TICKET = ['name' => 'bolaodezena.listar.bilhete', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const SHOW_BIND = ['name' => 'bolaodezena.mostrar', 'roles' => [UserLevel::ADMIN->value]];
    const SHOW_BOLLON = ['name' => 'bolaodezena.mostrar.bolao', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const SHOW_TICKET = ['name' => 'bolaodezena.mostrar.bilhete', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    ...
    const STORE_TICKET = ['name' => 'bolaodezena.criar.bilhete', 'roles' => [UserLevel::OPERATOR->value]];
