...
class BolaoPermissions
{
    ...
    const LIST_BOLLON = ['name' => 'bolao.listar.bolao', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const LIST_TICKET = ['name' => 'bolao.listar.bilhete', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    ...
    const STORE_TICKET = ['name' => 'bolao.criar.bilhete', 'roles' => [UserLevel::OPERATOR->value]];
    const SHOW_BIND = ['name' => 'bolao.mostrar', 'roles' => [UserLevel::ADMIN->value]];
    const SHOW_BOLLON = ['name' => 'bolao.mostrar.bolao', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
    const SHOW_TICKET = ['name' => 'bolao.mostrar.bilhete', 'roles' => [UserLevel::MANAGER->value, UserLevel::OPERATOR->value]];
